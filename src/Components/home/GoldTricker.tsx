...
/* ─────────────────────────────────────────
   GOLD TICKER
   Real tech stack from Ahmed Attia's CV
  ...
  return (
    <div
      style={{
        ...
        height:       "var(--space-ticker-height)",
    ...
    >
      ...
      <div
        style={{
          ...
          bottom:        0,
          width:         80,
          background:    "linear-gradient(270deg, var(--color-gold-primary), transparent)",
          zIndex:        2,
          pointerEvents: "none",
        }}
      />
      ...
      {/*
        ...
        CSS animation in globals.css moves it left by 50%
        then resets. Because items are rendered twice,
